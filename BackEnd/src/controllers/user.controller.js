...
import { trusted,mongoose } from "mongoose";
...
const registerUser =asyncHandler(async(req,res)=>{
    ...
    return res.status(201).json(
        new ApiResponse(200,createdUser,"User registeration Successful")
    )
})
...
const updateAccountDetails=asyncHandler(async(req,res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(2000,user,"account detail updated"))
})
